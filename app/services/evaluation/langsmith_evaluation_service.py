...
class LangsmithEvaluationService:
    ...
    def create_dataset(self) -> uuid.UUID:
    ...
    async def add_example(self, graph_output: InputAgentState):
        ...
        try:
            ...
            # Flatten messages if necessary
            messages = parsed_output["messages"]
            if isinstance(messages, list):
                messages = " ".join([m.content for m in messages])
